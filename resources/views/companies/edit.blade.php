                 ...
                 <form method="POST" action="{{ route('companies.update', $company) }}" class="space-y-6">
                     ...
                     <div>
                         ...
                         <select name="theme" id="theme"
                             ...
                             <option value="minimal" @selected(old('theme', $company->theme)==='minimalist')>Minimal</option>
                             <option value="modern" @selected(old('theme', $company->theme)==='corporate')>Modern</option>
