                 ...
                 <form method="POST" action="{{ route('companies.update', $company) }}" class="space-y-6">
                     ...
                     <div>
                         ...
                         <select name="theme" id="theme"
                             ...
                             <option value="minimalist" @selected(old('theme', $company->theme)==='minimalist')>Minimal</option>
                             <option value="corporate" @selected(old('theme', $company->theme)==='corporate')>Modern</option>
                             <option value="dark" @selected(old('theme', $company->theme)==='dark')>Dark</option>
                         </select>
